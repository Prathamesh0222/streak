...
export const Main = () => {
  return (
    <div className="p-6 w-full bg-gray-50 min-h-screen">
      <div className="bg-white border border-gray-200 rounded-2xl h-full p-8 shadow-sm">
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
            <div className="border border-gray-200 p-6 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 bg-white hover:border-red-200 group">
            ...
            <div className="border border-gray-200 p-6 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 bg-white hover:border-red-200 group md:col-span-2 lg:col-span-1">
